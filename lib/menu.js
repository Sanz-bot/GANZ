...
HALO MASTER☺️ *${id.split("@s.whatsapp.net")[0]}* 
...
Berikut ini beberapa command Yang bisa saya lakukan ${BotName}:
...
🔥_*!chord*_ <judul lagu>
_${BotName}_🏮 akan mengirimkanmu chord musik yang kamu inginkan
...
🔥 _*!pokemon*_
_${BotName}_🏮akan mengirimkanmu Gambar Pokemon Secara acak
...
🔥 _*!infoig*_ <nama instagram>
_${BotName}_🏮akan memberi tahu biodata instagram yang kamu inginkan
contoh : !infoig bijionta

🔥 _*!namaninja*_ <nama kamu>
_${BotName}_🏮akan memberi tahu nama ninja dari nama kamu
contoh : !namaninja bijikelot
...
🔥 _*!infogempa*_
_${BotName}_🏮akan menampilkan data tentang gempa bumi
...
ITU SAJA FITUR _${BotName}_ YANG BISA SAIA BERIKAN
JIKA ADA KEKURANGAN SAIA MOHON MAAP 
